...
public class MainActivity extends AppCompatActivity {
    ...
    private TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            {
                RadioButton rb =(RadioButton)findViewById(R.id.radio_metre);
                rb.setChecked(true);
            }
        }
    ...
    String interpreteIMC(float imc){

        String  reponse = "";
        if(imc <= 16.5) reponse =getString(R.string.famine);
        else if(imc <= 18.5) reponse =getString(R.string.maigreur);
        else if(imc <= 25) reponse = getString(R.string.corpulence_normale);
        else if(imc <= 30) reponse = getString(R.string.surpoids);
        else if(imc <= 35) reponse = getString(R.string.obesite_modere);
        else if(imc <= 40) reponse = getString(R.string.obesite_severe);
        else {
            reponse = getString(R.string.obesite_morbide);
        }
